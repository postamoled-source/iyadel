...
import { Download, Package, Settings, Search } from "lucide-react";
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4 sm:gap-6">
            {filtered.map((app, i) => (
              <motion.div
                ...
                className="flex flex-col rounded-3xl bg-card p-4 text-center shadow-sm ring-1 ring-border transition hover:-translate-y-1 hover:shadow-lg sm:p-5"
              >
