    ...
    <section className="bg-[#FFFBEB] dark:bg-[#1E1B4B] transition-colors duration-300 py-16" id="tools">
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        {showList && filtered.length > 0 &&
          <>
        <h2 className="mt-6 mb-4 text-left text-[20px] font-bold text-[#111827] dark:text-[#FEF3C7] [font-family:'Abril_Fatface',_system-ui]">{activeCategory === "Favorites" ? t("Favorites") : activeCategory === "All" ? t("All Tools") : `${t("Popular")} ${t(activeCategory)}`}</h2>
