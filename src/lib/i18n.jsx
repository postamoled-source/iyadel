...
const AR = {
  ...
  "Down": "أسفل",
  "Snake": "الثعبان",
  "Classic snake in a nature garden — smooth glide, eat the fruit to grow longer.": "لعبة الثعبان الكلاسيكية في حديقة طبيعية — انزلاق سلس، كُل الفاكهة واطول.",
  "Swipe or arrows to steer. Eat the fruit to grow — don't hit the walls or yourself!": "اسحب أو استخدم الأسهم للتوجيه. كُل الفاكهة لتكبر — وتجنّب الجدران وجسمك!",
