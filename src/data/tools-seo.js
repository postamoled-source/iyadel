...
export const TOOLS_SEO = {
  "coupon-code-generator": {
    title: "Generate Unique Coupon Codes with Prefix & CSV Export - Free Bulk Tool",
    metaDescription: "Generate thousands of unique discount codes with custom prefix, suffix & CSV export for Shopify and WooCommerce. Anti-duplicate, anti-confusable chars. Free, no signup.",
    h1: "Coupon Code Generator - Bulk Unique Promo Codes",
    keywords: "generate unique coupon codes with prefix and csv export, bulk discount code generator for shopify and woocommerce, create custom promo codes without duplicates free, how to generate thousands of unique coupon codes in browser, coupon code generator with prefix suffix and dash grouping, free online bulk promo code creator no signup no watermark, exclusive discount code generator for seasonal campaigns black friday ramadan",
    content: "A coupon code generator creates random, unique discount codes you can import straight into Shopify, WooCommerce, or any POS system that accepts CSV. It is built for big seasonal campaigns — Black Friday, Ramadan sales, launch giveaways — where you need hundreds or thousands of single-use codes instead of one shared promo. You control the character length (8-12 is the sweet spot), a campaign prefix like SALE or BF2026, an optional suffix like -VIP or -NEW, and dash grouping so long codes stay readable. The default character set automatically excludes confusable characters — O, 0, I, 1, L — that cause up to 5% of customers to mistype codes at checkout and abandon the cart. Uniqueness is guaranteed by checking each new code against the run as it is generated, so every customer receives a code nobody else can redeem. Export the finished list as CSV in one click and upload it directly to Shopify's Discount > Bulk create, or import via WooCommerce Smart Coupons. No signup, no watermark, all generation happens locally in your browser — your codes never leave your device.",
    faqs: [
      { q: "Can I generate codes with a custom prefix like SALE2026?", a: "Yes. Type SALE2026 in the prefix field, set the random length (for example 4), and generate — codes come out like SALE2026-A7X9K2. The prefix is not counted toward the random length, so every code stays unique. Export to CSV when done." },
      { q: "How does the generator prevent duplicate coupon codes?", a: "Each new code is checked against all codes already produced in the run using a Set-based lookup, so duplicates are rejected instantly. For safety across separate campaigns, use a different prefix per campaign (BF for Black Friday, RAM for Ramadan)." },
      { q: "What code length works best for Shopify and WooCommerce?", a: "8 to 12 characters total is the sweet spot: short enough for customers to type on mobile, long enough that codes cannot be guessed. A 4-6 character prefix plus 4-6 random characters works well. Shopify supports up to 255 characters, but keep it practical." },
      { q: "Does the tool exclude confusable characters like O and 0?", a: "Yes. The default character set removes O, 0, I, 1, and L — the characters most often confused on printed materials and mobile keyboards. This alone can cut checkout failures by up to 5%." },
      { q: "Can I export the generated codes to CSV for bulk import?", a: "Yes. Click Export CSV and upload the file to Shopify (Discounts > Create discount > Bulk create) or import via WooCommerce Smart Coupons. Make sure the file has a single column named 'code' and uses UTF-8 encoding." },
      { q: "Is the coupon code generator free and does it work offline?", a: "Yes, completely free with no signup or watermark. After the page loads, all codes are generated in your browser — no data is sent to any server, and it keeps working without an internet connection." },
    ],
  },
  ...
  "weight-converter": {
    title: "Precise KG to LBS Converter - 2.20462 Factor, Grams to Ounces Free",
    metaDescription: "Convert kg to lbs with exact 2.20462 factor. Grams to ounces, stones to kg, metric vs US ton. Precise weight converter for cooking, gym, shipping. Free.",
    h1: "Weight Converter - KG to LBS, Grams to Ounces",
    keywords: "precise kg to lbs converter 2.20462 factor, how to convert kilograms to pounds for cooking, grams to ounces conversion chart for baking, stone to kg body weight UK, metric ton vs short ton vs long ton difference, fluid ounce vs dry ounce weight, carat to grams jewelry conversion, milligram to gram precise recipe, how many grams in an ounce exactly 28.3495",
    content: "Convert weight and mass units with exact international factors — not the rounded 2.2 that loses 462 grams on every 100 kg. This converter handles kilograms to pounds (factor 2.20462), grams to ounces (28.3495 g per oz), stones to kilograms for UK body weight, carats for jewelry, milligrams for precise recipes, and all three ton types: metric (1,000 kg), US short (907.18 kg), and imperial long (1,016.05 kg). Whether you're converting a foreign recipe that calls for 8 ounces of flour, checking if your gym plates are 20 kg or 45 lb, or verifying a shipping contract that says 'ton' without specifying which — this tool gives you the precise number instantly. It distinguishes dry ounces (mass, 28.3495 g) from fluid ounces (volume, 29.5735 ml), a confusion that ruins more recipes than any other conversion mistake. Live conversion in both directions as you type.",
    faqs: [
      { q: "How do I convert kg to lbs with the exact factor?", a: "Multiply by 2.20462 (not 2.2). 70 kg × 2.20462 = 154.32 lb. The exact factor is 2.20462262185, but six decimal places cover any practical use. Using 2.2 instead loses 462 grams per 100 kg." },
      { q: "How many grams are in one dry ounce?", a: "One dry ounce = 28.3495 g exactly. A fluid ounce is different: 29.5735 ml. For cooking, 100 g ≈ 3.53 oz. Always check whether your recipe means dry ounces (weight) or fluid ounces (volume)." },
      { q: "What is a stone in kg?", a: "One stone = 6.35029 kg = 14 lb. It's the traditional British body-weight unit. 12 stone ≈ 76.2 kg. The converter handles stones in both directions." },
      { q: "What's the difference between metric ton, US ton, and imperial ton?", a: "Metric tonne = 1,000 kg. US short ton = 907.18 kg. British imperial long ton = 1,016.05 kg. The gap between metric and US is nearly 10% — always verify which ton a shipping contract uses." },
      { q: "How do I convert carats to grams?", a: "One carat = 200 mg = 0.2 g, used in the gemstone and gold trade. A 2-carat diamond weighs 0.4 g. The converter handles carats alongside milligrams for precise measurements." },
      { q: "Does the tool distinguish dry ounces from fluid ounces?", a: "The weight converter handles dry ounces (mass): 1 oz = 28.3495 g. Fluid ounces are a volume unit (29.5735 ml) — the converter focuses on mass, not volume, to avoid the recipe-ruining mix-up between the two." },
    ],
  },
  "logo-maker": {
