...
export const STATIC_TOOLS = [
  ...
  },
  {
    ...
    slug: "ideal-weight",
    category: "Health",
    description: "Calculate your ideal weight by height and age using four global formulas. Free tool + comprehensive guide with charts and FAQs.",
    description_ar: "احسب وزنك المثالي حسب الطول والعمر بأربع معادلات عالمية. أداة مجانية + دليل شامل بالجداول والأسئلة الشائعة.",
    icon: "Scale",
