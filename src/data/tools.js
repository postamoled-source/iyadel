...
export const STATIC_TOOLS = [
  ...
  },
  {
    ...
    icon: "Languages",
    content: "A Duolingo-style language-learning game with a talking globe mascot. Pick a language from the top menu — English, Arabic, French, Spanish, Italian, German, Japanese or Portuguese — then work through 12 themed levels (greetings, family, numbers, colors, food, animals, routines, school, time, travel, weather & feelings, conversations), with 15 to 35 questions per level as you advance. Use the Swap feature to choose the language you learn and your own language — meanings and answers appear in your language, not just Arabic. Six exercise types: choose the Arabic meaning of a foreign word, listen to a spoken word and pick its meaning, complete the blank in a sentence, arrange cut-up words into a correct sentence, type the word in the target language, and understand phrases the character speaks. The browser's speech engine pronounces every word and sentence in the correct language, and the mascot praises you aloud on correct answers. Wrong answers send you back to the same question until you answer it correctly, so you can't advance to the next level without mastering every question. Five hearts, a streak bonus, and your best score per language is saved on your device. Everything runs in your browser — nothing is uploaded.",
  },
  {
    name: "Snake",
    slug: "snake-game",
