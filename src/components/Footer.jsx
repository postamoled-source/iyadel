      ...
      <div className="max-w-6xl mx-auto px-6 py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        <div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <a href="https://apps.apple.com/app/testpeak/id123456789" target="_blank" rel="noopener noreferrer" aria-label="Download on the App Store">
        ...
        <div>
          ...
          <a href="mailto:support@testpeak.net" className="flex items-center gap-2 text-sm text-background/70 hover:text-accent transition-colors">
            <Mail className="w-4 h-4" /> support@testpeak.net
          </a>
        </div>
      </div>
